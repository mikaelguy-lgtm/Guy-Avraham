...
require_environment_names \
  ...
  EMAIL_DELIVERY_ENABLED PUBLIC_REGISTRATION_ENABLED EXTERNAL_PORTALS_ENABLED SUPER_ADMIN_ONLY_MODE SMTP_PORT \
  VITE_API_BASE_URL VITE_FIREBASE_API_KEY VITE_FIREBASE_AUTH_DOMAIN VITE_FIREBASE_PROJECT_ID \
  VITE_FIREBASE_STORAGE_BUCKET VITE_FIREBASE_MESSAGING_SENDER_ID VITE_FIREBASE_APP_ID VITE_USE_FIREBASE_EMULATOR \
  VITE_EMAIL_DELIVERY_ENABLED VITE_PUBLIC_REGISTRATION_ENABLED VITE_EXTERNAL_PORTALS_ENABLED VITE_SUPER_ADMIN_ONLY_MODE \
...
compose "$RELEASE_DIRECTORY" up -d api frontend worker
