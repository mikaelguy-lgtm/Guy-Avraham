...
export function makeStore(overrides: Partial<AppStore> = {}): AppStore {
  ...
  const defaults: Partial<AppStore> = {
    ...
    updateClientPersonal: async () => null,
    updateClientIncome: async () => null,
    updateClientLiabilities: async () => null,
    updateClientProperty: async () => null,
    updateClientDealDetails: async () => null,
    getClientDetails: async (id) => id === 1 ? {borrowers: [
      {id: 1, borrowerOrder: 1, isPrimary: true, firstNameEncrypted: encryption.encrypt("Dana"), lastNameEncrypted: encryption.encrypt("Levi"), identityNumberEncrypted: encryption.encrypt("123456789"), birthDateEncrypted: encryption.encrypt("1985-06-15"), birthDate: null, phoneEncrypted: encryption.encrypt("0500000000"), emailEncrypted: encryption.encrypt("dana@example.com"), addressEncrypted: encryption.encrypt("Street 1"), cityEncrypted: encryption.encrypt("Tel Aviv"), streetAddressEncrypted: encryption.encrypt("Street 1"), housingStatus: "OWNED", housingStatusOtherEncrypted: null, maritalStatus: "MARRIED", numberOfChildren: 0, childrenAges: [], employmentType: "SALARIED", employerNameEncrypted: encryption.encrypt("Employer"), jobTitle: "Manager", employmentStartDate: null, employmentSeniorityYears: 6, selfEmployedBusinessTypeEncrypted: null, selfEmployedBusinessStartYear: null, selfEmployedLastAssessedIncome: null, selfEmployedAssessmentYear: null, selfEmployedAccountantIncomePreviousYear: null, selfEmployedAccountantIncomeCurrentYear: null, selfEmployedAccountantMonthsCount: null, monthlyNetIncome: 30000, hasAdditionalIncome: true, additionalIncomeType: "RENTAL_INCOME", additionalIncomeAmount: 5000, additionalIncomeDescriptionEncrypted: null, liabilities: []},
      {id: 2, borrowerOrder: 2, isPrimary: false, firstNameEncrypted: encryption.encrypt("Noam"), lastNameEncrypted: encryption.encrypt("Levi"), identityNumberEncrypted: encryption.encrypt("987654321"), birthDateEncrypted: encryption.encrypt("1987-08-20"), birthDate: null, phoneEncrypted: encryption.encrypt("0500000001"), emailEncrypted: encryption.encrypt("noam@example.com"), addressEncrypted: encryption.encrypt("Street 1"), cityEncrypted: encryption.encrypt("Tel Aviv"), streetAddressEncrypted: encryption.encrypt("Street 1"), housingStatus: "OWNED", housingStatusOtherEncrypted: null, maritalStatus: "MARRIED", numberOfChildren: 0, childrenAges: [], employmentType: "SELF_EMPLOYED", employerNameEncrypted: encryption.encrypt("Business"), jobTitle: "Owner", employmentStartDate: null, employmentSeniorityYears: 8, selfEmployedBusinessTypeEncrypted: encryption.encrypt("Consulting"), selfEmployedBusinessStartYear: 2019, selfEmployedLastAssessedIncome: 200000, selfEmployedAssessmentYear: 2024, selfEmployedAccountantIncomePreviousYear: 180000, selfEmployedAccountantIncomeCurrentYear: 190000, selfEmployedAccountantMonthsCount: 6, monthlyNetIncome: 15000, hasAdditionalIncome: false, additionalIncomeType: null, additionalIncomeAmount: 0, additionalIncomeDescriptionEncrypted: null, liabilities: []}
    ], birthDate: new Date("1985-06-15"), employmentType: "SALARIED", employerNameEncrypted: encryption.encrypt("Employer"), jobTitle: "Manager", employmentStartDate: null, employmentSeniorityYears: 6, monthlyNetIncome: 30000, hasAdditionalIncome: true, additionalIncomeType: "RENTAL_INCOME", additionalIncomeAmount: 5000, additionalIncomeDescriptionEncrypted: null, householdLiabilities: [{id: 1, scope: "HOUSEHOLD", liabilityType: "MORTGAGE", otherTypeDescriptionEncrypted: null, currentBalance: 400000, monthlyPayment: 6000, endDate: "2035-01-01", notesEncrypted: encryption.encrypt("Mortgage"), legacyStatus: null}], loanPurpose: "SECOND_HAND_PURCHASE", loanPurposeOtherEncrypted: null, propertyType: "APARTMENT", propertyTypeOtherDescriptionEncrypted: null, propertyCity: "Tel Aviv", propertyAddressEncrypted: encryption.encrypt("Street 1"), propertyValue: 2000000, requestedAmount: 1000000, financingPercentage: 50, latestSubmissionStatus: null} : null,
    ...
    getActiveEmailConfiguration: async () => null,
    createEmailConfiguration: async (values) => ({
      id: 1,
    ...
    clearEmailConfigurationPassword: async () => null,
    markEmailConfigurationTest: async () => null,
    activateEmailConfiguration: async () => null,
    rollbackEmailConfiguration: async () => null,
